    ...
    public class RestaurantContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TakeoutOrder>().HasData(
                ...
                new TakeoutOrder { TakeoutOrderId = 2, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(4), Price = 10.11, State = (int)OrderState.Made, OrderedByUserId = 5, ManagedByWaiterId = 1 },
                ...
                new TakeoutOrder { TakeoutOrderId = 4, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(3), Price = 15.49, State = (int)OrderState.Made, OrderedByUserId = 5, ManagedByWaiterId = 3 },
                ...
                new TakeoutOrder { TakeoutOrderId = 6, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(6), Price = 100, State = (int)OrderState.Created, OrderedByUserId = 5, ManagedByWaiterId = 2 },
                ...
                new TakeoutOrder { TakeoutOrderId = 8, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(15), Price = 100, State = (int)OrderState.Made, OrderedByUserId = 5, ManagedByWaiterId = 1 },
                new TakeoutOrder { TakeoutOrderId = 9, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(13), Price = 100, State = (int)OrderState.Created, OrderedByUserId = 5, ManagedByWaiterId = 2 },
                ...
                new TakeoutOrder { TakeoutOrderId = 11, OrderDate = DateTime.Now, OrderedForDate = DateTime.Now.AddHours(2), ConfirmationDate = DateTime.Now.AddMinutes(10), Price = 100, State = (int)OrderState.Made, OrderedByUserId = 5, ManagedByWaiterId = 1 },
